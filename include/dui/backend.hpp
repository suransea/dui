...
enum class SurfacePixelFormat { rgba8888_srgb_premultiplied };
...
public:
  ...
  enum class PresentStatus { presented, out_of_date, lost };
...
enum class SurfaceAcquireStatus { ready, unavailable, out_of_date, lost, consumed };
...
public:
  ...
  virtual void render(SurfaceFrame& frame, const LayerTree& layer_tree,
                      const SurfaceRequest& request) = 0;
};
...
public:
  ...
  enum class FrameOutcome { presented, unavailable, out_of_date, canceled, failed };
